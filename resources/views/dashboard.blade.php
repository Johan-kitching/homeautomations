                ...
                <div class="card-header ">
                    <div class="row">
                        <div class="col-sm-6 text-left">
                            <h5 class="card-category">Avg Temps</h5>
                            <h2 class="card-title">Office</h2>
                        </div>
                        <div class="col-sm-6">
                            <div class="btn-group btn-group-toggle float-right" data-toggle="buttons">
                            <label class="btn btn-sm btn-primary btn-simple active" id="t0">
                            ...
                            <label class="btn btn-sm btn-primary btn-simple" id="t1">
                            ...
                            <label class="btn btn-sm btn-primary btn-simple" id="t2">
